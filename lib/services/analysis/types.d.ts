...
import type { LogFn, AffinityCache, ShortTermOptions, InMemoryTemporaryEntry } from '../../types';
export interface AnalysisAffinityStore {
    ...
    save: (seed: {
        ...
        selfId?: string;
        session?: Session;
    }, value: number, relation: string, extra?: Record<string, unknown>) => Promise<unknown>;
    ...
    resolveLevelByAffinity: (affinity: number) => {
        relation?: string;
    } | null;
