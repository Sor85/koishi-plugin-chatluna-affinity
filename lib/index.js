...
var OtherSettingsSchema = import_koishi6.Schema.object({
  ...
  affinityGroups: import_koishi6.Schema.array(
    import_koishi6.Schema.object({
      groupName: import_koishi6.Schema.string().required().description("\u5206\u7EC4\u540D\u79F0"),
      botIds: import_koishi6.Schema.array(import_koishi6.Schema.string()).default([]).description("\u7EC4\u5185 Bot \u7684 selfId \u5217\u8868")
    })
...
function createAffinityStore(options) {
  ...
  const resolveGroupSelfId = (selfId) => {
...
function registerRankCommand(deps) {
  ...
  ctx.command("affinity.rank [limit:number] [image]", "\u67E5\u770B\u5F53\u524D\u597D\u611F\u5EA6\u6392\u884C", { authority: 1 }).alias("\u597D\u611F\u5EA6\u6392\u884C").action(async ({ session }, limitArg, imageArg) => {
